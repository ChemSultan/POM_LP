...
class LPSolver:
    def __init__(self, data_folder: str):
        ...
        # ─── 7) 운송 용량 상수 정의 ───
        #    facility-origin일 때만 사용 (store-origin 없으므로 U_store는 생략)
        self.U_wh = 75640024.69
...
if __name__ == "__main__":
    ...
    wh_vars = [v.varName for v in solver.model.getVars() if "CA_wh" in v.varName]
    wh_constrs = [
        c.ConstrName for c in solver.model.getConstrs() if "CA_wh" in c.ConstrName
    ]
